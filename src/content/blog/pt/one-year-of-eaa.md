...
<figure class="article-visual">
  ...
  <ol class="article-timeline">
    <li><strong>17 de abril de 2019</strong><br>A Diretiva é adotada.</li>
    <li><strong>28 de junho de 2022</strong><br>Prazo de transposição pelos Estados-Membros.</li>
    <li><strong>28 de junho de 2025</strong><br>As medidas aplicáveis começam a operar.</li>
...
<figure class="article-visual">
  ...
  <ol class="article-standards">
    <li>Requisitos do European Accessibility Act</li>
...
<figure class="article-visual">
  ...
  <div class="article-actions">
    <section>
      <h3>Design</h3>
      <p>Definir teclado, foco, erros, reflow, áreas de toque, contraste e alternativas antes da implementação.</p>
    </section>
    <section>
      <h3>Engenharia</h3>
      <p>Executar verificações rápidas no CI e manter testes manuais com teclado e tecnologias de apoio nas alterações relevantes.</p>
    </section>
    <section>
      <h3>Produto</h3>
      <p>Manter um backlog de acessibilidade com responsáveis e ligar o feedback público à triagem.</p>
    </section>
    <section>
