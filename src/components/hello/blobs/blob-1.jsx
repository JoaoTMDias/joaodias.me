...
export const BlobOne = () => {
	return (
		<Blob xmlns="http://www.w3.org/2000/svg" viewBox="0 0 502 502" aria-labelledby="about-blob-title" tabIndex="-1">
			...
			/>
			<circle cx="81.88" cy="495.46" r="6.54" className="blob__shape" fill="var(--color-gray1, #f0ecec)" />
			<path
				className="blob__shape"
				fill="var(--color-gray1, #f0ecec)"
				fillRule="evenodd"
			...
			/>
			<circle cx="374.65" cy="493.44" r="8.56" className="blob__shape" fill="var(--color-gray1, #f0ecec)" />
			<circle cx="365.69" cy="8.56" r="8.56" className="blob__shape" fill="var(--color-gray1, #f0ecec)" />
		</Blob>
	);
};

const Blob = styled.svg`
	--fill-color: var(--color-gray1, #f0ecec);
	position: absolute;
	width: 100%;
	height: auto;
	z-index: -1;
