        ...
        >
          <figure className={styles.link__icon}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              ...
              <path className={styles.link__filled} fill="#fff" d="M23.87 10.83L12 0 .13 10.83a.4.4 0 0 0 0 .58.43.43 0 0 0 .59 0L2.48 9.8V24H9.1v-7.58a2.9 2.9 0 0 1 5.8 0V24h6.62V9.8l1.78 1.63a.46.46 0 0 0 .29.11.43.43 0 0 0 .3-.13.4.4 0 0 0-.02-.58z" />
              <path className={styles.link__stroke} fill="#fff" d="M23.87 10.83L12 0 .13 10.83a.41.41 0 0 0 0 .58.43.43 0 0 0 .3.13.46.46 0 0 0 .29-.11L2.48 9.8V24H9.1v-7.58a2.9 2.9 0 0 1 5.8 0V24h6.62V9.8l1.78 1.63a.46.46 0 0 0 .29.11.43.43 0 0 0 .3-.13.4.4 0 0 0-.02-.58zm-3.35-1V23H15.9v-6.58a3.9 3.9 0 0 0-7.8 0V23H3.48V9.13L12 1.35l8.52 7.78z" />
            </svg>
          </figure>

          <span className={styles.link__label}>Home</span>
        </Link>
      </li>
        ...
        >
          <figure className={styles.link__icon}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              ...
              <path className={styles.link__stroke} fill="#fff" d="M14.73 19.83l-5-7.12 12.82-8.2zM8.91 18.1l.55-4.42 1.82 2.6zM21.14 4.48l-12 7.68-7.35-2.41zm2.77-1.34a.43.43 0 0 0-.36-.14h-.09L.3 9.33a.38.38 0 0 0-.3.37.4.4 0 0 0 .28.39l8.47 2.79L8 19a.41.41 0 0 0 .2.4.46.46 0 0 0 .2 0 .41.41 0 0 0 .24-.08l3.11-2.38 2.72 3.89a.37.37 0 0 0 .32.17.39.39 0 0 0 .33-.22L24 3.58a.39.39 0 0 0-.09-.44z"/>
              <path className={styles.link__filled} fill="#fff" d="M14.94 20.86l-5.75-8.22L24 3.17l-9.06 17.69zM8.21 18.86l.64-5.1 2.1 3.01-2.74 2.09zM22.33 3.14L8.48 12.01 0 9.22l22.33-6.08z"/>
            </svg>
          </figure>
          <span className={styles.link__label}>Contact</span>
        </Link>
      </li>
    </ul>
  </div>
