...
import articleStyles from "../latest-articles/index.module.scss";
				...
				>
					{filteredArticles.map((article) => (
						<li key={article.id} className={styles["result-item"]}>
							<article className={articleStyles["featured-article"]}>
								<a href={`/blog/${article.id}`} className={articleStyles["featured-article__link"]}>
									{article.featuredImage ? (
										<img
											className={articleStyles["featured-article__cover"]}
									...
									<div className={articleStyles["featured-article__content"]}>
										<time
											...
											className={articleStyles["featured-article__date"]}
										>
